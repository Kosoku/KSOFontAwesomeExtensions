 ...
 */
+ (nullable UIFont *)KSO_fontAwesomeRegularFontOfSize:(CGFloat)size;
/**
 ...
 */
+ (nullable UIFont *)KSO_fontAwesomeSolidFontOfSize:(CGFloat)size;
/**
 ...
 */
+ (nullable UIFont *)KSO_fontAwesomeBrandFontOfSize:(CGFloat)size;
/**
 ...
 */
+ (nullable UIFont *)KSO_fontAwesomeLightFontOfSize:(CGFloat)size;
/**
 ...
 */
+ (nullable UIFont *)KSO_fontAwesomeFontWithName:(NSString *)name size:(CGFloat)size;
